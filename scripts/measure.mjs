...
report(await measure('/g/sea-anemones'), '(the 19-object page — the stamina test)')
report(await measure('/g/sea-anemones', { scroll: true, settle: 4000 }), '(19-object page, scrolled to the end)')
